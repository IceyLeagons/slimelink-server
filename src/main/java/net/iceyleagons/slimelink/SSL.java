...
public class SSL {
     ...
     */
    public static SSLContext getSSLContextFromLetsEncrypt() {
        SSLContext context;
        String pathTo = "pem";
        ...
        } catch (IOException | KeyManagementException | KeyStoreException | InvalidKeySpecException | NoSuchAlgorithmException | CertificateException | UnrecoverableKeyException e) {
